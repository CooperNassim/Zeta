...
import { Plus, Edit, Play, Pause, Upload, Download, Trash2, KeyRound } from 'lucide-react'

const Toolbar = ({ onAdd, onEdit, onEnable, onDisable, onImport, onExport, onDelete, onResetPassword, canEdit, canEnable, canDisable, canExport, canDelete, canResetPassword, totalCount, hideAdd, hideImport, hideDelete, editLabel }) => {
  return (
